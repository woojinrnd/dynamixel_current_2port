    ...
    else if (Get_corner_det_flg_2d() || (Get_corner_det_flg_3d() && Get_corner_det_flg_2d()))
    {
        ...
        else if (tmp_corner_seq == 2)
        {
            ...
            if (!Get_select_motion_on_flg())
            {
                ...
                else if (tmp_turn90 == 1 && !Get_turn_angle_on_flg())
                {
                    corner_motion = Motion_Index::Step_in_place;
                    Set_motion_index_(corner_motion);
                    Set_select_motion_on_flg(true);
                ...
                else if (tmp_turn90 == 2 && !Get_turn_angle_on_flg())
                {
                    corner_motion = Motion_Index::Step_in_place;
                    Set_motion_index_(corner_motion);
                    Set_select_motion_on_flg(true);
                ...
                else if (tmp_turn90 == 3 && !Get_turn_angle_on_flg())
                {
                    Set_turn_angle_(30);
                    Set_turn_angle_on_flg(true);
                    tmp_turn90++;
...
/* void Move_Decision::Test_service()
{
    if (aaaa == 0)
    {
        ...
        if (!Get_select_motion_on_flg())
        {
            ...
            if (ccc == 0 && !Get_turn_angle_on_flg())
            {
                Set_UD_NeckAngle(30);
                Set_UD_Neck_on_flg(true);
            ...
            else if (ccc == 1 && !Get_turn_angle_on_flg())
            {
                Set_motion_index_(Motion_Index::Step_in_place);
                Set_select_motion_on_flg(true);
            ...
            else if (ccc == 2 && !Get_turn_angle_on_flg())
            {
                Set_motion_index_(Motion_Index::Step_in_place);
                Set_select_motion_on_flg(true);
    ...
    else if (aaaa == 1 && !Get_select_motion_on_flg())
    {
    ...
    else if (aaaa == 2 && !Get_select_motion_on_flg())
    {
    ...
    else if (aaaa == 3 && !Get_select_motion_on_flg())
    {
    ...
    else if (aaaa == 4 && !Get_select_motion_on_flg())
    {
        Set_motion_index_(Motion_Index::Right_2step);
        Set_select_motion_on_flg(true);
        aaaa++;
    ...
    else if (aaaa == 5 && !Get_select_motion_on_flg())
    {
        Set_motion_index_(Motion_Index::Huddle_Jump);
        Set_select_motion_on_flg(true);
        aaaa = 0;
